...
def initialtion():
    init_list = [[0]*30 for i in range(100)]
    for i in range(0, 100):
        for j in range(0, 30):
            init_list[i][j] = random.uniform(0, 100)
    return init_list
...
def draw(clusters):
    ...
    plt.show()
    #plt.savefig('C:\\Users\\Evil\\Desktop\\mycode\\Pic\\clu-dps.png')
...
if __name__ == '__main__':
    ...
    #print(len(dataSet))
    clusters = dbscan(dataSet, 4.67, 15)
